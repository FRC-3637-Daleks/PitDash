/**
 * Test file for Job: conn_status
 */

var assert = require ('assert');
conn_statusSUT = require('../conn_status');

var mockedConfig, mockedDependencies;

describe ('conn_status test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      conn_statusSUT(config, mockedDependencies, function(err, data){
